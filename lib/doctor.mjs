...
export function doctor(home, opts = {}) {
  ...
  const report = {
    ...
    state: { mode: state.mode, safeModeActive: state.safeMode?.active === true, lastSnapshot: state.lastSnapshot, lastGood: state.lastGood, lastRollback: state.lastRollback },
